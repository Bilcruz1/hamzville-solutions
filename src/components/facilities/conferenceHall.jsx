...
// Your images here
import img1 from '../../assets/slides/conferenceslides/slide1.png';
import img2 from '../../assets/slides/conferenceslides/slide2.png';
import img3 from '../../assets/slides/conferenceslides/slide3.png';
import img4 from '../../assets/slides/conferenceslides/slide4.png';
import img5 from '../../assets/slides/conferenceslides/slide5.png';
...
export default function ConferenceHall() {
	...
	return (
		<div className="relative bg-[url('/src/assets/slides/bg-luxury.png')] bg-cover w-full lg:px-[120px] lg:pt-[120px] pt-[23px] lg:pb-[120px] lg:mt-[120px] mt-[80px]">
